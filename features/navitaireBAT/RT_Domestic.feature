...
Feature: This feature file is to run Naviataire BAT scenarios
     ...
     Scenario Outline:RT, Domestic flight with Infant in lap and Child with 1 CO and 1 CK bag, Seat &Modify WWW booking via MT
          ...
          When  I am on landing page I select "BLV" for the departure airport
          And  I am on landing page I select "VPS" for the destination airport
          ...
          Then I am on Manage Travel page, I expect "<productTotal>" is updated correctly for traveler "<paxNum>" 
            ...
            Examples:
             | date |adult  | child | InfantInSeat |InfantInLap | Addproduct    | paxNum | productTotal  | changeDate |    CarryOn       |        Check             | Seats                    |
             |   7  |   2   |  1    |        0     |      1     | 1 checked bag | 1      | 1 checked bag | 9          | pax-all Seg-both | pax-all Seg-both count-1 | pax-all Seg-all type-any |
