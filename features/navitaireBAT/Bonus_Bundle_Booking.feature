...
#PASS
    ...
    Scenario Outline:Domestic-Bonus Bundle Booking, RT booking, 2 Adults
        ...
        # Then I create my allegaint account (LAS-SCK car is not available)
        ...
        Examples:
            ...
            | roundTrip | bonusbundle  | 2     | 0     | 0         | 0        | 26         | 4          | Visa     | pax-all Seg-departing | pax-2 Seg-both | pax-1 Seg-both count-1 | pax-all Seg-all type-any |
