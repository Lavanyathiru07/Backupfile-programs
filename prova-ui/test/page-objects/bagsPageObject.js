...
class BagsPage {
    ...
    async clickContinueButton() {
        ...
        await this.actions.waitForDisplayed(continueb, 'Continue button in BAGS PAGE', 10000)
        await this.actions.waitForClickable(continueb, 'Continue button in BAGS PAGE')
        ...
        if (popupContinueBtnVisibility) {
            await this.actions.waitForClickable(popupContinueButton, 'popupContinueButton')
            await this.actions.clickElement('click', popupContinueButton, "pop-up button for continue")
        }
