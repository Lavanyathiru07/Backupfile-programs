...
// function multitypeFunctionn(...elements:(number|string)[]):number{

//     return elements.length;
// }
// console.log(multitypeFunctionn(1,2,3,4,5));
// console.log(multitypeFunctionn("Hello","World"));
// console.log(multitypeFunctionn(1,"Hello",2,"World",3));
