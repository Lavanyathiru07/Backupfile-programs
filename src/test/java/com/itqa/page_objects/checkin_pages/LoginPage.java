        ...
        for (int i=0; i<2; i++) {
                ...
                try {
                    new WebDriverWait(driver,5)
                            .until(ExpectedConditions
                                    .elementToBeClickable(By.xpath("//span[contains(text(),'Close')]/..")));
            ...
            try {
                ...
                GeneralUtils.takeScreenshot(driver,
                        System.getProperty("user.dir")+"/src/test/resources/bookingScreenshot/Popup" +
                                itn.getScenario() + "check-in.png");
