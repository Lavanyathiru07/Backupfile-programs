...
public class BookingFlow extends BasePage {
	...
	public void WWWRefundAndCancellation(String itin, Itinerary itn) throws InterruptedException {
	...
	public void WWWUncheckRefundAndCancel(String itin, Itinerary itn) throws InterruptedException {
		if (Environment.getEnv().contains("qa2")) {
