...
public class NonBookingTestReport implements IReporter{
    ...
    private void writeReportHeader(){
        try {
            ...
            htmlStringBuilder.append("<font color=\"white\"><b>STATUS</b></font></td>");
            htmlStringBuilder.append("<td bgcolor=\"#FF9F33\" width=\"20%\" align=\"center\">");
    ...
    private void writeReportFooter() {
        GeneralUtils.writeToFile("Result.html","<tr><td bgcolor=\"#FF9F33\" colspan=\"5\"><font color=\"White\"><b>RELEASE FUNCTIONAL</font></td></tr>");
        GeneralUtils.writeToFile("Result.html", "<tr><td align=\"center\">&nbsp;</td><td>&nbsp;</td><td align=\"center\">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>");
    }
